...
private:
    ...
    void OutputModelResultNewRpn(int32_t modelId, const std::string& imgName) const;
    ...
    void FilterBbox(const float *outData, size_t wStrideOffset, uint32_t outHeight,
...
constexpr uint8_t CLASS_NUM = 5;
constexpr uint8_t OUT_PARM_NUM = CLASS_NUM + 5; /* x, y, w,h, obj , class(80) */
